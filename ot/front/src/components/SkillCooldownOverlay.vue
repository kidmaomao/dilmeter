...
const EFFECT_TIMER_HORIZONTAL_HEIGHT = 64;
const EFFECT_TIMER_VERTICAL_WIDTH = 72;
const EFFECT_TIMER_VERTICAL_HEIGHT = 220;
...
function effectTimerProgressStyle(item: EffectTimerOverlayItem) {
    ...
    return { transform: item.orientation === "vertical" ? `scaleY(${progress})` : `scaleX(${progress})` };
}
...
.effect-timer-card {
    ...
    padding: 8px;
    color: #f4fbff;
    background: linear-gradient(135deg, rgba(12, 21, 29, .96), rgba(19, 35, 43, .92));
    border: 1px solid rgba(111, 223, 255, .72);
    border-radius: 10px;
    box-shadow: 0 4px 14px rgba(0, 0, 0, .55), inset 0 0 16px rgba(57, 208, 238, .08);
...
.effect-timer-track i {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(90deg, #61d9ff, #7effc6);
    box-shadow: 0 0 9px rgba(91, 226, 255, .68);
...
.effect-timer-overlay-item.effect-vertical .effect-timer-body strong {
    width: 100%;
    text-align: center;
}

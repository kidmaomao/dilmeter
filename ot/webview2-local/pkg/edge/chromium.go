...
func validControllerBounds(bounds w32.Rect) bool {
...
// SetTransparentBackground configures the WebView2 composition surface so
// transparent HTML pixels reveal the native host window beneath it.
func (e *Chromium) SetTransparentBackground() error {
	...
	return controller2.PutDefaultBackgroundColor(COREWEBVIEW2_COLOR{})
}

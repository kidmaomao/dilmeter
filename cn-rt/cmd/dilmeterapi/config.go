...
const appDirectoryName = "MabinogiDpsDesktop"
...
type config struct {
	...
	GameServer               string `yaml:"game_server"`
...
// migrateLegacyAppData copies the previous roaming profile once, preserving
// user reminder profiles, custom sounds and logs without deleting the source.
